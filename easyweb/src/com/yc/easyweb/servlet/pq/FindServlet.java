...
public class FindServlet extends BaseServlet {
	...
	public void checkNext(HttpServletRequest request, HttpServletResponse response)
	...
	public void checkFinish(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.setCharacterEncoding("utf-8");
		response.setContentType("text/html; charset=UTF-8");
		String upassword = request.getParameter("upassword");

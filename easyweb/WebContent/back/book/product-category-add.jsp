...
<div class="type_style">
 <div class="type_title">产品类型信息</div>
  ...
  <label class="btn  btn-warning"><i class="icon-edit align-top bigger-125"></i>新增子类型</label>
  <input name="type_option" type="radio"class="btn  btn-warning" value="stop"/>
  <label href="javascript:ovid()" class="btn  btn-success"><i class="icon-ok align-top bigger-125"></i>禁用该类型</label>
  <input name="type_option" type="radio"class="btn  btn-warning" value="delete"/>
  <label href="javascript:ovid()" class="btn  btn-danger"><i class="icon-trash   align-top bigger-125"></i>删除该类型</label>
  </div>

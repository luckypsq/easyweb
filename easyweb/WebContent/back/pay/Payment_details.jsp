  ...
  <div class="brand_info clearfix">
   ...
   <form>
    ...
    <div class="brand_logo">
      <img src="<%=application.getContextPath() %>/back/products/black/yinglian.jpg" width="120px" height="60px">
      <p class="name">中国银联</p>
    </div>
   </form>
   </div>
   ...
   <div class="bank_style clearfix" id="Bank_operations">
      ...
      <div class="bank_list clearfix">
        <ul class="bank_logo clearfix">
         ...
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black7.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black8.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black9.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black10.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black11.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black12.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black13.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black14.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="<%=application.getContextPath() %>/back/products/black/black15.png" width="160px;"/></span></label></li>
        </ul>
...
function modify(){
	 ...
	 $('.ace').addClass("add");
	  ...
	  $('#Bank_operations').find('.Push_button').prepend('<span class="Button"><a style="text-decoration:none" class="btn btn-success" onClick="bank_complete(this,id)" href="<%=application.getContextPath() %>/back/javascript:;" title="启用"><i class=""></i>确认操作</a></span>');
	};

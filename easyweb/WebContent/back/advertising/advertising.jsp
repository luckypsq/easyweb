...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="<%=application.getContextPath() %>/back/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <script type="text/javascript" src="<%=application.getContextPath() %>/back/Widget/swfupload/swfupload.js"></script>
        <script type="text/javascript" src="<%=application.getContextPath() %>/back/Widget/swfupload/swfupload.queue.js"></script>
        <script type="text/javascript" src="<%=application.getContextPath() %>/back/Widget/swfupload/swfupload.speed.js"></script>
        <script type="text/javascript" src="<%=application.getContextPath() %>/back/Widget/swfupload/handlers.js"></script>
<title>广告管理</title>
</head>
...
<div class=" clearfix" id="advertising">
     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             ...
             <li><i class="fa fa-image pink "></i> <a href="<%=application.getContextPath() %>/back/#">首页轮播广告大(5)</a></li>
             <li> <i class="fa fa-image pink "></i> <a href="<%=application.getContextPath() %>/back/#">轮播广告小1(3)</a> </li>
             <li> <i class="fa fa-image pink "></i> <a href="<%=application.getContextPath() %>/back/#">轮播广告小2(3)</a></li>
             <li><i class="fa fa-image pink "></i> <a href="<%=application.getContextPath() %>/back/#">单个广告(6)</a></li>
         </ul>
  </div>
  </div>
  </div>  
   ...
   <div class="border clearfix">
       <span class="l_f">
        <a href="<%=application.getContextPath() %>/back/javascript:ovid()" id="ads_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加广告</a>
	...
	<tbody>
      <tr>
       ...
       <td>幻灯片</td>
       <td><span class="ad_img"><img src="<%=application.getContextPath() %>/back/products/ad.jpg"  width="100%" height="100%"/></span></td>
       <td>1890x1080</td>
       <td><a href="<%=application.getContextPath() %>/back/#" target="_blank">http://item.jd.com/10443270082.html</a></td>
...
<div id="add_ads_style"  style="display:none">
 ...
 <div class="demo">
	           <div class="logobox"><div class="resizebox"><img src="<%=application.getContextPath() %>/back/images/image.png" width="100px" alt="" height="100px"/></div></div>	
               <div class="logoupload">
                  <div class="btnbox"><a id="uploadBtnHolder" class="uploadbtn" href="<%=application.getContextPath() %>/back/javascript:;">上传替换</a></div>

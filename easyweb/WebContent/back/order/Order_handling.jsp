        ...
        <div class="widget-box side_content" >
         ...
         <div class="widget-body">
          <ul class="b_P_Sort_list">
             ...
             <li><i class="fa fa-sticky-note pink "></i> <a href="<%=application.getContextPath() %>/back/#">已完成(235)</a></li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="<%=application.getContextPath() %>/back/#">代付款(15)</a> </li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="<%=application.getContextPath() %>/back/#">代发货(56)</a></li>
             <li><i class="fa fa-sticky-note pink "></i> <a href="<%=application.getContextPath() %>/back/#">代收货(32)</a></li>
            </ul>
        </div>
       </div>
      </div>  
  ...
  <div class="search_style">
   ...
   <tr>
     ...
     <td class="order_product_name">
      <a href="<%=application.getContextPath() %>/back/#" class="product_Display"><img src="<%=application.getContextPath() %>/back/products/p_1.jpg"  title="产品名称"/></a>
      <i class="fa fa-plus"></i>
       <a href="<%=application.getContextPath() %>/back/#" class="product_Display"><img src="<%=application.getContextPath() %>/back/products/p_2.jpg"  title="产品名称"/></a>
     </td>
     <td>456.5</td>
     ...
     <td>20160705445622</td>
     <td class="order_product_name">
      <a href="<%=application.getContextPath() %>/back/#" class="product_Display">
      <img src="<%=application.getContextPath() %>/back/products/p_1.jpg"  title="产品名称"/>
      </a>
      <i class="fa fa-plus"></i>
       <a href="<%=application.getContextPath() %>/back/#" class="product_Display">
       <img src="<%=application.getContextPath() %>/back/products/p_2.jpg"  title="产品名称"/>
       </a>
     </td>
     <td>456.5</td>    
     <td>2016-7-5</td>

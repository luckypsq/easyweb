 ...
 <div class="amounts_style">
   <div class="transaction_Money clearfix">
      <div class="Money"><span >成交总额：1.2234.3456.00元</span><p>最新统计时间:2016-8-2</p></div>
       ...
       <a href="<%=application.getContextPath() %>/back/javascript:ovid()" title="当月统计" onclick="Statistics_btn()" class="btn  btn-info btn-sm no-radius"><i class="bigger fa fa-bar-chart "></i><h5 class="margin-top">当月统计</h5></a>
     </div>
    </div>
    <div class="border clearfix">
      <span class="l_f">
      <a href="<%=application.getContextPath() %>/back/javascript:ovid()" class="btn btn-info">全部订单</a>
      <a href="<%=application.getContextPath() %>/back/javascript:ovid()" class="btn btn-danger">当天订单</a>
        <a href="<%=application.getContextPath() %>/back/javascript:ovid()" class="btn btn-danger">当月订单</a>
       </span>

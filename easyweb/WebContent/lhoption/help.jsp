...
<div class="help-wrap">
	<div class="container clearfix">
		<div class="bread">当前位置：
			...
			<a href="<%=application.getContextPath() %>/lhoption/help.jsp">帮助中心</a> >
			<a href="<%=application.getContextPath() %>/lhoption/help.jsp">如何买书</a>
		</div>
		<div class="help-l fl">
			<div class="help-item">
		...
		<div class="help-r fr">
			...
			<div class="help-main">
				...
				<img src="<%=application.getContextPath() %>/images/help1.png" alt=""/>
				<p>第二步：您可通过邮箱/手机号码进行注册，按照提示填写准确信息，点击提交“立即注册”。</p>
				<img src="<%=application.getContextPath() %>/images/help2.JPG" alt=""/>
				<p>第三步：注册完成后，点击易书网首页顶部“登录”正常登录账户即可。</p>
				<h2>2.搜索商品</h2>
				<p>第一步：搜索自己想要的书籍</p>
				<img src="<%=application.getContextPath() %>/images/help3.png" alt=""/>
				<p>第二步：选好进入详情</p>
				<h2>3.购买书籍</h2>
				<p>第一步：点击购买即可</p>
				<img src="<%=application.getContextPath() %>/images/step4.png" alt=""/>
			</div>
		</div>
	</div>
</div>

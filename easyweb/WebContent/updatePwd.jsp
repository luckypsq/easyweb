	...
	<div id="wrapper">
		<div id="login" class="animate form">
			<form  action=""  method="post" >
				...
				<p> 
					<label for="password" class="youpasswd" data-icon="p">您的邮箱</label>
					<input id="uemail" name="password" required="required" type="text" 
					placeholder="请输入邮箱" />
				</p>
				<p> 
				...
				<div style="height:100px;">
					<button style="height:40px;background:white;width:131px;" onclick="">获取验证码</button>
				</div>
				<p>	</p>
				...
				<p class="change_link">
				          <a href="join.jsp" >登录</a>
					不是成员?<a href="join.jsp" class="to_register">加入我们</a>
				</p>			
			</form>
		</div>
